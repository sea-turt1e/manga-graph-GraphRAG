...
- 理想は5作品のうち以下のような割合とする。
  - 同じ作者の別作品: 2作品
    - ただし「ユーザーの好みの作品」で挙げられた作品の総集編などの派生作品は**使用禁止**。
    - キャラクターが異なるスピンオフなどは優先的に推薦すること。
  - 同雑誌の別作品: 2作品
    - 別作者の作品だとしても、「ユーザーの好みの作品」と関係が深い作品は優先的に推薦すること。
      - 例えば同じ作者が監修しているであろう作品で、別の作者が描いているものなど。
    - ただし作者が'不明'の場合は使用しない
  - 同出版社の他誌に掲載された作品: 1作品
